...
namespace compat {
    ...
    struct CpuProfiler : public AllStatic {
        inline static void StartCpuProfiling(v8::Isolate* isolate, v8::Local<v8::String> title = v8::Local<v8::String>());
        inline static const v8::CpuProfile* StopCpuProfiling(v8::Isolate* isolate, v8::Local<v8::String> title = v8::Local<v8::String>());
    };
    ...
    struct FunctionTemplate : public AllStatic {
        inline static v8::Local<v8::FunctionTemplate> New(v8::Isolate* isolate, FunctionCallback callback = 0);
    };
    ...
    struct Integer : public AllStatic {
        ...
        inline static v8::Local<v8::Integer> NewFromUnsigned(v8::Isolate* isolate, uint32_t value);
    };

    struct Isolate : public AllStatic {
        inline static void GetHeapStatistics(v8::Isolate* isolate, v8::HeapStatistics* stats);
        inline static void SetAddHistogramSampleFunction(v8::Isolate* isolate, v8::AddHistogramSampleCallback callback);
        inline static void SetCreateHistogramFunction(v8::Isolate* isolate, v8::CreateHistogramCallback callback);
        inline static void SetJitCodeEventHandler(v8::Isolate* isolate, v8::JitCodeEventOptions options, v8::JitCodeEventHandler handler);
        inline static v8::Local<v8::Value> ThrowException(v8::Isolate* isolate, v8::Local<v8::Value> exception);
    };
    ...
    struct String : public AllStatic {
        ...
        inline static v8::Local<v8::String> NewFromUtf8(v8::Isolate* isolate, const char* data, NewStringType type = kNormalString, int length = -1);
    };
